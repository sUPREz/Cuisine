...
(function ($) {
    $.widget("ui.tagit", {
        ...
        _addTag:function (label, value) {
            ...
            /* !! UPDATE !! LINK ADDED !! */
                + (value !== undefined ? ' tagValue="' + value + '"' : '') + '><a href="?area=allRecettes&tag='+ escape(label) +'">'
            /* !! UPDATE END !! */
                + (this.options.sortable == 'handle' ? '</a><a class="ui-icon ui-icon-grip-dotted-vertical" style="float:left"></a>' : '')
